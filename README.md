...
I maintain [selfoss](https://github.com/fossar/selfoss) RSS reader and help maintain GNOME desktop environment in [NixOS](https://github.com/NixOS/nixpkgs). I also work on lot of other [minor projects](https://github.com/jtojnar?tab=repositories&type=source&sort=stargazers) and [contribute](https://github.com/jtojnar?tab=repositories&q=&type=fork&sort=stargazers) [to many/most](https://gitlab.gnome.org/jtojnar) [open-source projects](https://gitlab.com/jtojnar) [I use](https://gitlab.freedesktop.org/jtojnar).
